...
button.addEventListener("click", () => {
  if (button.textContent === "Click Me! ❤") {
    ...
    fetch('send_mail.php')
      .then(response => {
        if (response.ok) {
          button.textContent = "KISS KISS ❤️";
        } else {
...
function drawText() {
    ...
    if(frameNumber > 2500 && frameNumber < 99999){
        ...
        if (window.innerWidth < 600) {
            ...
            context.fillText("I love you so much Ify, more than all the time and space in the universe can contain", canvas.width/2, canvas.height/2);
        }
